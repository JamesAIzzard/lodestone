...
Searches can be restricted to an inclusive date window. Email results use the server-received time and other files use their last modified time. See the [date-filter documentation](docs/date-filter/00-overview.md) for the design and client behaviour.
