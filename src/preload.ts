...
contextBridge.exposeInMainWorld('electronAPI', {
  // Dialogs & Shell
  selectDirectories: (): Promise<string[]> => ipcRenderer.invoke('dialog:selectDirectories'),
  selectDbFile: (): Promise<string | null> => ipcRenderer.invoke('dialog:selectDbFile'),
  ...
  disconnectSilo: (name: string): Promise<unknown> => ipcRenderer.invoke('silos:disconnect', name),
  ...
  // Activity
  getActivity: (limit?: number): Promise<unknown[]> => ipcRenderer.invoke('activity:recent', limit),
  ...
  // Defaults
  getDefaults: (): Promise<unknown> => ipcRenderer.invoke('defaults:get'),
  ...
  getMcpClientStatus: (clientId: string): Promise<unknown> =>
    ipcRenderer.invoke('mcp:getClientStatus', clientId),
  configureMcpClient: (clientId: string): Promise<unknown> =>
    ipcRenderer.invoke('mcp:configureClient', clientId),
  getClaudeDesktopStatus: (): Promise<unknown> => ipcRenderer.invoke('mcp:getClaudeDesktopStatus'),
  configureClaudeDesktop: (): Promise<unknown> => ipcRenderer.invoke('mcp:configureClaudeDesktop'),
