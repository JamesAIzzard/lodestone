...
export const mockSearchResults: SearchResult[] = [
  {
    ...
    scoreSource: 'content',
    axes: {
      content: { best: 0.91, bestSignal: 'semantic', signals: { semantic: 0.91, bm25: 0.52 } },
      filename: { best: 0, bestSignal: 'levenshtein', signals: { levenshtein: 0, tokenCoverage: 0 } },
    },
    chunks: [
      {
      ...
      },
      {
        ...
        content: { best: 0.85, bestSignal: 'semantic', signals: { semantic: 0.85, bm25: 0.33 } },
      },
    ],
  },
  {
    ...
    scoreSource: 'content',
    axes: {
      content: { best: 0.91, bestSignal: 'semantic', signals: { semantic: 0.91, bm25: 0.18 } },
      filename: { best: 0, bestSignal: 'levenshtein', signals: { levenshtein: 0, tokenCoverage: 0 } },
    },
    chunks: [
      {
  ...
  },
  {
    ...
    scoreSource: 'content',
    axes: {
      content: { best: 0.87, bestSignal: 'semantic', signals: { semantic: 0.87, bm25: 0.62 } },
      filename: { best: 0, bestSignal: 'levenshtein', signals: { levenshtein: 0, tokenCoverage: 0 } },
    },
    chunks: [
      {
      ...
      },
      {
        ...
        content: { best: 0.71, bestSignal: 'bm25', signals: { semantic: 0.12, bm25: 0.71 } },
      },
    ],
  },
  {
    ...
    scoreSource: 'content',
    axes: {
      content: { best: 0.87, bestSignal: 'semantic', signals: { semantic: 0.87, bm25: 0.24 } },
      filename: { best: 0, bestSignal: 'levenshtein', signals: { levenshtein: 0, tokenCoverage: 0 } },
    },
    chunks: [
      {
  ...
  },
  {
    ...
    scoreSource: 'content',
    axes: {
      content: { best: 0.85, bestSignal: 'bm25', signals: { semantic: 0.08, bm25: 0.85 } },
      filename: { best: 0, bestSignal: 'levenshtein', signals: { levenshtein: 0, tokenCoverage: 0 } },
    },
    chunks: [
      {
      ...
      },
      {
        ...
        content: { best: 0.79, bestSignal: 'bm25', signals: { semantic: 0.05, bm25: 0.79 } },
      },
      {
        sectionPath: [],
        ...
        content: { best: 0.74, bestSignal: 'bm25', signals: { semantic: 0.03, bm25: 0.74 } },
      },
    ],
  },
  {
    ...
    axes: {
      content: { best: 0.80, bestSignal: 'semantic', signals: { semantic: 0.80, bm25: 0.35 } },
      filename: { best: 0.83, bestSignal: 'levenshtein', signals: { levenshtein: 0.83, tokenCoverage: 0.5 } },
    },
    chunks: [
      {
  ...
  },
  {
    ...
    scoreSource: 'content',
    axes: {
      content: { best: 0.82, bestSignal: 'semantic', signals: { semantic: 0.82, bm25: 0.41 } },
      filename: { best: 0, bestSignal: 'levenshtein', signals: { levenshtein: 0, tokenCoverage: 0 } },
    },
    chunks: [
      {
  ...
  },
  {
    ...
    scoreSource: 'filename',
    axes: {
      content: { best: 0.71, bestSignal: 'semantic', signals: { semantic: 0.71, bm25: 0.38 } },
      filename: { best: 0.78, bestSignal: 'levenshtein', signals: { levenshtein: 0.78, tokenCoverage: 0.4 } },
    },
    chunks: [
      {
  ...
  },
  {
    ...
    scoreSource: 'content',
    axes: {
      content: { best: 0.75, bestSignal: 'bm25', signals: { semantic: 0.10, bm25: 0.75 } },
      filename: { best: 0, bestSignal: 'levenshtein', signals: { levenshtein: 0, tokenCoverage: 0 } },
    },
    chunks: [
      {
  ...
  },
  {
    ...
    scoreSource: 'content',
    axes: {
      content: { best: 0.75, bestSignal: 'semantic', signals: { semantic: 0.75, bm25: 0.22 } },
      filename: { best: 0, bestSignal: 'levenshtein', signals: { levenshtein: 0, tokenCoverage: 0 } },
    },
    chunks: [
      {
  ...
  },
  {
    ...
    scoreSource: 'content',
    axes: {
      content: { best: 0.70, bestSignal: 'semantic', signals: { semantic: 0.70, bm25: 0.58 } },
      filename: { best: 0, bestSignal: 'levenshtein', signals: { levenshtein: 0, tokenCoverage: 0 } },
    },
    chunks: [
      {
  ...
  },
  {
    ...
    scoreSource: 'content',
    axes: {
      content: { best: 0.68, bestSignal: 'semantic', signals: { semantic: 0.68, bm25: 0.15 } },
      filename: { best: 0, bestSignal: 'levenshtein', signals: { levenshtein: 0, tokenCoverage: 0 } },
    },
    chunks: [
      {
